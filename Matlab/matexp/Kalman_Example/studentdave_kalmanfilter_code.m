...
QuailAccel_noise_mag = .5; %process noise: the variability in how fast the Quail is speeding up (stdv of acceleration: meters/sec^2)
NinjaVision_noise_mag = 3;  %measurement noise: How mask-blinded is the Ninja (stdv of location, in meters)
